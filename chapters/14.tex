...
\begin{enumerate}[label=(\roman*)]
\item \textit{Agentivity}. Agents are usually conceived of as animate. Inanimate referents can leak into animate genders when they are construed as agents. In Zande (Atlantic-Congo, Ubangi), nouns referring to inanimate things usually control inanimate gender, but can take animate gender when animacy is imputed on them, as in (\ref{ex:WDG:4}):
...
The possibility of positing an independent gender value for lexical plural\slash pluralia tantum nouns has also been defended for Russian by \cite{Zaliznjak1977}. Russian has a tripartite gender system with a masculine-feminine-neuter distinction that is further subject to a number of animacy-based conditions. Gender distinctions are neutralized in the plural. Pluralia tantum nouns always trigger plural agreement, irrespectively of whether they refer to singular or plural entities. This is illustrated in (\ref{ex:WDG:79}).
...
\begin{multicols}{2}
\begin{tabbing}\relax
\scshape affirmation  \= actualis (Coastal Marind)\kill
[ ]	\>	non-overt element	\\
( )	\>	inherent category	\\
...
I,II,III,IV	\>	Genders I, II, III and\\
            \> IV in Coastal Marind\\
\scshape iii	\>	Gender \textsc{iii} in Archi	\\
1	\>	first person	\\
2	\>	second person	\\
3	\>	third person	\\
\scshape a	\>	actor	\\
...
\scshape ass	\>	associative case (Uduk)	\\
\scshape attr	\>	attributive (Archi)	\\
\scshape aux	\>	auxiliary	\\
\scshape caus	\>	causative	\\
\scshape cl	\>	class	\\
\scshape cl1 \normalfont etc.	\>	class 1 etc.	\\
\scshape clf	\>	classifier	\\
\scshape cm	\>	common gender; common\\ \> noun marker (not person \\ \>  name marker: Tagalog)\\
...
\scshape detr	\>	detransitivizing ``em-\\ \>phatic'' form of verb \\ \> (Bari)	\\
...
\scshape dn	\>	default noun gender \\ \> (Nalca)	\\
\scshape dp	\>	default phrase gender \\ \> (Nalca)	\\
\scshape du	\>	dual	\\
\scshape erg	\>	ergative	\\
\scshape f	\>	feminine	\\
\scshape flat	\>	flat	\\
\scshape fut	\>	future	\\
\scshape gen	\>	genitive; possession \\ \> (Pnar)	\\
...
\scshape int	\>	interrogative \\ \> (Coastal Marind)	\\
\scshape ipfv	\>	imperfective aspect	\\
\scshape iter	\>	iterative mood \\ \> (Meskwaki)	\\
\scshape \itshape ka	\>	\textit{ka}-class (Paumarí)	\\
...
\scshape m	\>	masculine	\\
\scshape make	\>	light verb `make'\\ \> (Oksapmin)	\\
\scshape medial	\>	medial	\\
\scshape n	\>	neuter gender	\\
\scshape n\_	\>	non-	\\
\scshape n1	\>	neuter 1 (Mian)	\\
\scshape n2	\>	neuter 2 (Mian)	\\
\scshape narr	\>	narrative	\\
\scshape neg	\>	negation	\\
\normalfont Neg.indef	\>	negative indefinite\\ \> pronoun	\\
\scshape neut	\>	neutral orientation\\ \> (Coastal Marind) 	\\
\scshape nf	\>	non-finite (Pnar \sectref{sec:WDG:4.3})	\\
...
\scshape pred	\>	predicator (Mian)	\\
\scshape prf	\>	perfect	\\
\scshape prox	\>	proximal; proximate\\ \> (Meskwaki)	\\
