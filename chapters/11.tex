...
For three of the sampled languages, \ili{Kundjeyhmi} (Central \ili{Gunwinyguan}), \ili{Aghul} (\ili{Lezgic}), and \ili{Udi} (\ili{Lezgic}), the patterns of change behind the reduction and loss of gender agreement patterns cannot be fully inferred based on the data at our disposal.
