...
\stepcounter{footnote}\footnotetext{Kuot has no independent third person personal pronouns (Eva Lindström, p.c.). However, demonstratives are used with pronominal functions (see also Footnote \ref{fn:Svard:19} below).}
