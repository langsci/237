...
\ili{Naga}, \ili{Angami} (njm)	&	\{süpfü\}	&	\textit{sü-pfü} \textsc{dem-f}	\\
...
\ili{Ixil}, \ili{Nebaj} (ixi)	&	ixoj	&	\textit{ixoj(e)} woman	\\
\ili{Mam}, \ili{Todos Santos} (mvj)	&	>xuj\#<	&	\textit{xuj} ‘old woman’, \textit{txin} young woman, \textit{te-} to	\\
\ili{Cuicatec}, \ili{Teutila} (cut)	&		&	\textit{ta̱hn} full form, \textit{te} reduced form	\\
\ili{Cuicatec}, \ili{Tepeuxila} (cux)	&	tá, táⁿ\textquotesingle{}ā, ta	&	\textit{táⁿ’ā} full form, \textit{tá/ta} reduced form	\\
\ili{Mixtec}, \ili{Atatlahuca} (mib)	&	ña	&	\textit{ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Ocotepec} (mie)	&	ña	&	\textit{ña} \textsc{f}	\\
\ili{Mixtec}, \ili{San Miguel} (mig)	&	>-ñ<	&	\textit{-ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Peñoles} (mil)	&	>-aⁿ\#<	&	\textit{-aⁿ} \textsc{f}	\\
\ili{Mixtec}, \ili{Pinotepa Nacional} (mio)	&	ña	&	\textit{ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Southern Puebla} (mit)	&		&	\textit{‑nè}, \textit{-ne}, \textit{-né}, \textit{‑ñá}, \textit{-ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Coatzospan} (miz)	&		&	\textit{tún} \textsc{f} (girls), adult respect \textit{ña}	\\
\ili{Mixtec}, \ili{San Juan Colorado} (mjc)	&	ña	&	\textit{ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Silacayoapan} (mks)	&	ñá	&	\textit{ñá} \textsc{f}	\\
\ili{Mixtec}, \ili{Yosondúa} (mpm)	&	ña	&	\textit{ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Tezoatlan} (mxb)	&	>án\#<	&	\textit{án}, \textit{-án} \textsc{f}	\\
\ili{Mixtec}, \ili{Jamiltepec} (mxt)	&	ña	&	\textit{ña} \textsc{f}	\\
\ili{Mixtec}, \ili{Diuxi-Tilantongo} (xtd)	&	>-ña<	&	\textit{‑ña}, \textsc{f} \textit{nuu} ‘to’	\\
\ili{Triqui}, \ili{Copala} (trc)	&	no\textquotesingle{}	&	\textit{no’} \textsc{f}	\\
\ili{Triqui}, \ili{San Martin Itunyoso} (trq)	&	ún\textquotesingle{}	&	\textit{ún’} \textsc{f}	\\
\ili{Popoloca}, \ili{San Marcos Tlalcoyalco} (pls)	&		&	\textit{nc̈ha} ‘woman[\textsc{ana}]’, \textit{xan} ‘child, child[\textsc{ana}]’	\\
\ili{Mazatec}, \ili{Chiquihuitlan} (maq)	&	na	&	\textit{na} \textsc{f}	\\
\ili{Zapotec}, \ili{Ozoltepec} (zao)	&		&	\textit{nzaa} girl	\\
\ili{Zapotec}, \ili{Quioquitani Quieri} (ztq)	&	me	&	\textit{me} \textsc{f}	\\
\ili{Zapotec}, \ili{Rincon} (zar)	&	>nu<	&	\textit{-nu} \textsc{f}	\\
\ili{Zapotec}, Southern \ili{Rincon} (zsr) 	&	>nu<	&	\textit{-nu} \textsc{f}	\\
\ili{Zapotec}, \ili{Santo Domingo Albarradas} (zas)	&		&	\textit{-m} \textsc{f}	\\
\ili{Zapotec}, \ili{Lachixio} (zpl)	&	>nchu\#<	&	\textit{-nchu} \textsc{f}	\\
\ili{Zapotec}, \ili{Amatlan} (zpo)	&	me	&	\textit{me} \textsc{f}, \textit{xaa} \textsc{honor}	\\
\ili{Zapotec}, \ili{Texmelucan} (zpz)	&		&	\textit{fiñ}, \textit{ñi}, \textit{-ñ} \textsc{f}, \textit{mi}, \textit{-m} \textsc{respect}	\\
...
\ili{Huitoto}, \ili{Minica} (hto)	&	afengo, \{aféngona\}	&	\textit{afe-ngo} \textsc{dist-f}	\\
...
\ili{Mazatec}, \ili{Ayautla} (vmy)	&	chjunbiu	&	\textit{chjun} ‘woman’	\\
...
\ili{South Tairora} (omw)	&	nraakyeva	&	\textit{nraakye} ‘woman’, \textit{-ve} \textsc{dem}	\\
...
\ili{Mocovi} (moc)	&	aso’maxare	&	\textit{a-so’-maxare} \textsc{f-going-pro}	\\
\lspbottomrule
\end{tabularx}
...
\lsptoprule
 Language &  Extracted form &  Remarks \\
\midrule
\ili{Zapotec}, \ili{Miahuatlan} (zam)	&	\{xa\textquotesingle{}\}	&	\textit{xa’} 3 \textsc{m/f}, \textit{mza’} girl	\\
\ili{Zapotec}, \ili{Chichicapan} (zpv)	&	bi	&	\textit{bi} 3 \textsc{m/f}, \textit{ba} 3.\textsc{respect}	\\
\lspbottomrule
\end{tabularx}
